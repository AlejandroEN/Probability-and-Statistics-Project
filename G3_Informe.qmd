...
ggplot(filter(RECH5, !is.na(hemoglobina)), aes(x = "", y = hemoglobina)) +
  geom_boxplot(fill = "#66c2a5", color = "#333333") +
...
Entre los índices de riqueza, vemos que en los más pobre existe una mayor dispersión de datos. Sin embargo, no hay mucha distinción en los casos bajos de hemoglobina por cada separación ---que indica si se presenta anemia---.

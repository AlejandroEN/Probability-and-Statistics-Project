...
#### 4.1.1 Edad de niños VS Frecuencia de la anemia leve
...
hist(niños_anemia_leve$edad,
     main = "Edad de los infantes con anemia leve",
     xlab = "Edad en meses",
     ylab = "Número de infantes con anemia leve",
     col = "skyblue")
...
#### 4.1.2 Edad de niños VS Frecuencia de la anemia moderada

```{r, echo=FALSE}

hist(niños_anemia_moderada$edad,
     main = "Edad de los niños con anemia moderada",
     xlab = "Edad en meses",
...
#### 4.1.3 Edad de niños VS Frecuencia de la anemia grave

```{r, echo=FALSE}

hist(niños_anemia_grave$edad,
     main = "Edad de los infantes con anemia grave",
     xlab = "Edad en meses",
...
En los casos leves de anemia en infantes, observamos que las concentraciones más significativas se sitúan entre los 10 y 45 meses de edad. En los casos moderados, la mayor concentración se encuentra alrededor de los 5 y 35 meses, mientras que para los casos graves, la concentración más prominente se registra entre los 7 y 30 años. En los tres escenarios, la información se presenta altamente dispersa. Es importante destacar que el gráfico de los casos de anemia moderada exhibe una distribución que sugiere una asimetría hacia la izquierda, similar a una campana.

### 4.2 Edad de mujeres VS Frecuencias de anemia

#### 4.2.1 Edad de mujeres VS Frecuencia de la anemia grave
...
#### 4.2.2 Edad de mujeres VS Frecuencia de la anemia moderada
...
#### 4.2.3 Edad de mujeres VS Frecuencia de la anemia grave

```{r, echo=FALSE}

hist(mujeres_anemia_grave$edad,
     main = "Edad de las mujeres con anemia grave",
     xlab = "Edad en años",
...
En el caso de mujeres con anemia leve, se destaca que las concentraciones más notables se ubican alrededor de los 17 y 38 años de edad. Para los casos moderados, la mayor concentración se registra en torno a los 20 y 35 meses, mientras que en los casos graves, se observa un pico entre los 22 y 44 años. Al igual que en los casos de infantes, los datos exhiben una alta dispersión. Es relevante señalar que, específicamente en los casos
...
Claramente se observa una tendencia consistente en los tres casos, donde los casos leves son consistentemente predominantes. La elección de focalizar en las tres regiones con mayor incidencia de casos se fundamenta en la necesidad de dirigir mayores esfuerzos y recursos para combatir la enfermedad. Estas regiones identificadas no solo presentan una mayor prevalencia, sino que también pueden ser consideradas como puntos críticos que demandan una atención prioritaria en las estrategias de prevención y control de la anemia.
...
#### 4.4.1 Boxplots entre hemoglobina e índice de riqueza con las mujeres
...
boxplot(ds_hemoglobina_riqueza$hemoglobina ~ ds_hemoglobina_riqueza$indice_riqueza,
        ...
        ylab = "Nivel de hemoglobina (g/dl)")
```

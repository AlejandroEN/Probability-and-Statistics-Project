...
-   **Población:** Hogares particulares y sus miembros obtenidos de la Encuesta Demográfica y de Salud Familiar. (en base a nuestro estudio)

    -   **Tamaño de la población:** 36.650
...
madres_promedios_anemia_leve <- 
  data.frame(colMeans(madres_anemia_leve[ ,
                                          sapply(madres_anemia_leve,
                                                 is.numeric)]))

madres_promedios_anemia_moderada <-
  data.frame(colMeans(madres_anemia_moderada[ ,
                                              sapply(madres_anemia_moderada, 
                                                     is.numeric)]))

madres_promedios_anemia_grave <- 
  data.frame(colMeans(madres_anemia_grave[ ,
                                           sapply(madres_anemia_grave,
                                                  is.numeric)]))
...
Anemia_Riqueza_Madres <- merge(RECH5,
                               RECH23,
                               by.x = "cuestionario_individual_id",
                               by.y = "cuestionario_hogar_id")

Anemia_Riqueza_Madres$indice_riqueza <- 
  as.factor(Anemia_Riqueza_Madres$indice_riqueza)

...
Region_vs_Nivel_de_Anemia <- 
  data.frame(Region = c("Amazonas",
                        ...
                        "Tumbes",
                        "Ucayali"),
  Leve = c(191, 182, 211, 139, 233, 164, 157, 168, 202, 219, 130, 187,
           140, 155, 521, 325, 241, 101, 199, 165, 215, 218, 106, 214, 331),
  Moderado = c(83, 66, 82, 36, 96, 47, 57, 102, 155, 115, 44, 75, 59, 48,
               162, 173, 107, 27, 118, 60, 125, 79, 46, 57, 180),
  Grave = c(0, 0, 0, 0, 3, 0, 0, 0, 1, 7, 1, 0, 2, 1, 0, 2, 0, 0, 5, 0, 4,
            0, 1, 0, 0))

Region_vs_Nivel_de_Anemia$Total <- 
  rowSums(Region_vs_Nivel_de_Anemia[ , 2:4])

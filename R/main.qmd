...
La anemia representa un importante desafío de salud pública en nuestro país. La deficiencia de hemoglobina en la sangre puede acarrear graves consecuencias. Entre ellas, se incluye el potencial impacto negativo en el desarrollo físico y cognitivo de los niños, así como el aumento del riesgo de complicaciones durante el embarazo en las mujeres. Por tanto, resulta fundamental comprender tanto la prevalencia como la gravedad de la anemia en estos grupos de población para poder abordar de manera adecuada esta cuestión de salud en nuestra nación.
...
La totalidad de la información recopilada en esta encuesta se encuentra disponible para consulta por parte de cualquier ciudadano en la base de datos del Instituto Nacional de Estadística e Informática (INEI). Los datos se presentan organizados en módulos temáticos, y el enfoque de nuestro interés recae en aquel relacionado con la prevalencia de anemia.
...
Region_vs_Nivel_de_Anemia$Total <- rowSums(df[,2:4])
...
# Create a named vector for categorizing

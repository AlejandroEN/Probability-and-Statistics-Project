...
**Experimento 1.** Escoger un hogar que aceptó participar en la encuesta y observar la región a la que pertenece.

**Espacio muestral:** Son los nombres de cada región del Perú, que se encuentran en la variable *region* de la tabla REC0111.
...
La intersección de estos dos eventos resultó ser igual a 0 debido a que son mutuamente excluyentes, es decir, no pueden ocurrir simultáneamente. Según la regla, al ser mutuamente excluyentes, no son eventos independientes.

Dado que no son eventos independientes, no son disjuntos, lo que nos lleva a realizar las siguientes verificaciones.
